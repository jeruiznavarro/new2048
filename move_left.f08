subroutine move_left(auxiliary_empty_cells,auxiliary_empty_cells_history,current_empty_cells_history,empty_cells,empty_cells_history,matrix,matrix_history,score_history)
		...
		do i=0,cells-2
			...
			if((matrix(i,j)==matrix(i+1,j)).and.(matrix(i,j)>0))then
				...
				do
					...
					if((k==cells-1).and.(matrix(k,j)==0))then
